...
<div class="col-sm-6 text-left" >
     ...
     <ol class="breadcrumb">
         <li class="breadcrumb-item active">Group 4: Attendance Management System</li>
     </ol>
</div>
@endsection
                                ...
                                <div class="card bg-info text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-16 text-uppercase mt-0 text-white">Total <br> Employees</h5> 
                                        </div>
                                ...
                                <div class="card bg-info text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-16 text-uppercase mt-0 text-white">On Time <br> Today</h5>
                                ...
                                <div class="card bg-info text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-16 text-uppercase mt-0 text-white">Late <br> Today</h5>
                                ...
                                <div class="card bg-info text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h6  class="font-16 text-uppercase mt-0 text-white" >On Time <br> Percentage</h6>
                                ...
                                <div class="card bg-info text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-16 text-uppercase mt-0 text-white">Availabe <br> Schedules</h5> 
                                        </div>
