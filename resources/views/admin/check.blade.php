                ...
                <thead class="thead-dark">
                    ...
                    <tbody>
                        ...
                        <form action="{{ route('check_store') }}" method="post">
                            ...
                            <button type="submit" class="btn btn-success btn-info" style="display: flex; margin:10px">Submit Attendance</button>
                            <h4>Legend: [ ] -> Time in</h4>
                            <h4>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp [ ] -> Time out</h4>
                            @csrf
